...
- **Quellen der Inhalte:** FAQ (`src/components/Faq.tsx` + `src/data/faq.json`, zweisprachig) ist server- und clientseitig identisch (keine `Date`/`window`-Abhängigkeit im Rendering).

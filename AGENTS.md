...
- Trigger: `workflow_dispatch` (extern per Server-Cron getriggert via `scripts/install-cron.sh`: Mo–Fr alle 2h 06:00–20:00 MEZ/MESZ, Sa/So 06:00+14:00 + täglich 22:30 MEZ/MESZ), `push` auf `main`. Kein `schedule`-Cron (GitHub-Limit: 10 Runs/Woche).

...
export const i18n = {
  de: {
    ...
    chgModelRemoved: "{model} entfernt ({pricing}, war {days} Tage verfügbar)",
    ...
    statsSubDesc: "monatlich kündbar",
    ...
    trainingFilter: "Modelle mit Model Training anzeigen",
    capImage: "Bild",
    capVideo: "Video",
    capAudio: "Audio",
    capDocs: "Dokumente",
    ...
    peak: "Peak",
    offPeak: "Off-Peak",
    peakTooltip: "{phase}: {utc} UTC · lokale Zeit: {local} · Wechsel in {countdown} · {weekend}",
    ...
    usageUnlimited: "Unbegrenzte Nutzung (kostenloses Modell)",
    usageTooltip:
    ...
    rankingIntro:
      "Die Modelle mit den meisten Anfragen pro Monat beim vollen {credit}-Guthaben — berechnet aus dem in der Doku dokumentierten Anfragemuster.",
    rankingColRank: "Platz",
    rankingColModel: "Modell",
    rankingColProvider: "Anbieter",
    rankingColContext: "Kontext",
    rankingColRequests: "Anfragen/Monat",
    rankingColCost: "≈ $/Anfrage",
    rankingNote:
      "Anfragen pro Monat = inkl. Nutzung ÷ Kosten pro Anfrage (Listenpreis). Die Kosten pro Anfrage folgen dem Anfragemuster (Input: 5% Input-Preis + 95% Cached-Write-Preis, Cached: Cached-Read-Preis, Output: Output-Preis). Die vollständige Preistabelle steht oben.",
  ...
  en: {
    ...
    chgModelRemoved: "{model} removed ({pricing}, was available {days} days)",
    ...
    trainingFilter: "Show models with model training",
    capImage: "Image",
    capVideo: "Video",
    capAudio: "Audio",
    capDocs: "Docs",
    ...
    peak: "Peak",
    offPeak: "Off-Peak",
    peakTooltip: "{phase}: {utc} UTC · local time: {local} · changes in {countdown} · {weekend}",
    ...
    usageUnlimited: "Unlimited usage (free model)",
    usageTooltip:
    ...
    rankingIntro:
      "The models with the most requests per month on the full {credit} credit — based on each model's documented request pattern.",
    rankingColRank: "Rank",
    rankingColModel: "Model",
    rankingColProvider: "Provider",
    rankingColContext: "Context",
    rankingColRequests: "Requests/mo",
    rankingColCost: "≈ $/request",
    rankingNote:
      "Requests per month = included usage ÷ cost per request (list price). Cost per request follows the documented pattern (input: 5% input price + 95% cache-write price, cached: cached-read price, output: output price). The full price table is above.",

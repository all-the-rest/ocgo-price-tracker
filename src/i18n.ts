...
export const i18n = {
  de: {
    ...
    metricNote:
      "Preise wahlweise auf Basis des vollen $60-Monatsguthabens (Effektivpreis = Listenpreis × 60/Nutzung) oder dessen, was du zahlst ($10/Monat, Effektivpreis = Listenpreis × 10/Nutzung). Kosten pro Anfrage = Modellpreis × dokumentiertes Anfragemuster (Input-Tokens: 5% Input-Preis + 95% Cached-Write-Preis, Cached-Tokens: Cached-Read-Preis, Output-Tokens: Output-Preis — Heuristik). Fehlt ein Cached-Write-Preis („-“), zählt er wie der Input-Preis.",
